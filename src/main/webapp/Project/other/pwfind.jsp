...
<link href="/web/Project/css/pwfind.css" rel="stylesheet" type="text/css">
<!-- <style type="text/css">
.newjoin3{
	margin-top : 150px;
...
<div class="con">
<label id="name" style="font-size: 20px;">아이디</label>
<input type="text" placeholder="아이디" id="nametext"><br><br>
